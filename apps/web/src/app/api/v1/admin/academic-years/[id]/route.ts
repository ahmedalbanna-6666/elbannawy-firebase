...
export async function PATCH(
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: { code: 'INTERNAL', message: 'Failed to update academic year' } }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: { code: 'INTERNAL', message: 'Failed to delete academic year' } }, { status: 500 });
  }
}
