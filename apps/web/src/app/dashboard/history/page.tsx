...
const ACTIVITY_BG: Record<string, string> = {
  video_watched: "bg-primary-500/10",
  video_completed: "bg-primary-500/10",
  ...
  live_class_joined: "bg-success-500/10",
  live_class_booked: "bg-success-500/10",
  story_started: "bg-orange-500/10",
  story_completed: "bg-orange-500/10",
  game_played: "bg-purple-500/10",
  review_started: "bg-danger-500/10",
  achievement_earned: "bg-purple-500/10",
  xp_earned: "bg-warning-500/10",
...
const ACTIVITY_ICON_COLOR: Record<string, string> = {
  video_watched: "text-primary-500",
  video_completed: "text-primary-500",
  ...
  live_class_joined: "text-success-500",
  live_class_booked: "text-success-500",
  story_started: "text-orange-500",
  story_completed: "text-orange-500",
  game_played: "text-purple-500",
  review_started: "text-danger-500",
  achievement_earned: "text-purple-500",
  xp_earned: "text-warning-500",
