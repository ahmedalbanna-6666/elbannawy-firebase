...
export function PwaInstallPrompt(): ReactNode {
  ...
  return (
    <div className="fixed bottom-[calc(72px+env(safe-area-inset-bottom,0px)+8px)] left-4 right-4 z-50 lg:bottom-6 lg:left-auto lg:ltr:right-6 lg:rtl:left-6 lg:w-96">
