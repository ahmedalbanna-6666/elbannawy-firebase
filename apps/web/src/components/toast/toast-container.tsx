...
export function ToastContainer(): ReactNode {
  ...
  return (
    <div aria-live="polite" aria-atomic="false" className="fixed bottom-24 left-1/2 z-[200] flex w-full max-w-sm -translate-x-1/2 flex-col gap-2 px-4 lg:bottom-6 lg:left-auto lg:ltr:right-6 lg:rtl:left-6 lg:translate-x-0">
      {toasts.map((toast) => {
