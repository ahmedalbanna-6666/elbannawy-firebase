...
const cardVariants = cva(
  "rounded-2xl transition-shadow duration-300 dark:border dark:border-white/5 dark:bg-none dark:bg-[var(--color-surface)]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-white to-neutral-50 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.6),0_1px_2px_0_rgba(0,0,0,0.03),0_2px_8px_-1px_rgba(0,0,0,0.04),0_12px_32px_-8px_rgba(0,0,0,0.03)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03),0_1px_2px_0_rgba(0,0,0,0.25),0_4px_14px_-2px_rgba(0,0,0,0.20),0_12px_36px_-8px_rgba(0,0,0,0.15)]",
        elevated:
        ...
        gradient:
          "bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-[0_0_0_1px_rgba(6,182,212,0.12),0_2px_6px_-1px_rgba(6,182,212,0.06),0_12px_28px_-8px_rgba(6,182,212,0.08),0_24px_48px_-14px_rgba(6,182,212,0.04)] dark:from-primary-500 dark:to-primary-700 dark:border-white/10 dark:shadow-[0_0_0_1px_rgba(6,182,212,0.15),0_2px_8px_-1px_rgba(0,0,0,0.30),0_12px_28px_-8px_rgba(0,0,0,0.25),0_24px_52px_-16px_rgba(0,0,0,0.18)]",
        premium:
          "bg-gradient-to-b from-white to-neutral-50 shadow-[0_0_0_1px_rgba(6,182,212,0.18),0_2px_8px_-1px_rgba(6,182,212,0.08),0_12px_32px_-10px_rgba(6,182,212,0.12),0_28px_56px_-16px_rgba(6,182,212,0.06)] dark:bg-[var(--color-surface-elevated)] dark:shadow-[0_0_0_1px_rgba(6,182,212,0.20),0_2px_10px_-1px_rgba(0,0,0,0.30),0_12px_32px_-10px_rgba(0,0,0,0.25),0_28px_60px_-18px_rgba(0,0,0,0.18)]",
      },
      padding: {
        none: "p-0",
        sm: "p-4",
      ...
      interactive: {
        true: [
          ...
          "dark:hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_2px_6px_-1px_rgba(0,0,0,0.30),0_8px_22px_-4px_rgba(0,0,0,0.25),0_20px_48px_-12px_rgba(0,0,0,0.18)]",
          "dark:active:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02),0_1px_2px_0_rgba(0,0,0,0.20),0_3px_10px_-2px_rgba(0,0,0,0.15)]",
        ],
      },
    },
    defaultVariants: {
