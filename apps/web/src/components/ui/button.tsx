...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 select-none touch-target-y",
  {
    variants: {
      variant: {
        primary:
      ...
      size: {
        xs: "h-9 px-3 text-xs min-h-[36px]",
        sm: "h-11 px-4 text-sm min-h-[44px]",
        md: "h-12 px-6 text-sm min-h-[44px]",
        lg: "h-14 px-8 text-base min-h-[44px]",
        xl: "h-16 px-10 text-base min-h-[44px]",
