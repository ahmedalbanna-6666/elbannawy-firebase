...
Architecture documents are the source of design truth.

Code is the source of implementation truth.

If code conflicts with architecture documentation,

the architecture documentation wins.

If implementation details are not in the documentation,
...
docs/firebase/DOMAIN_MODEL.md

8.

docs/firebase/REPOSITORY_CONTRACTS.md

9.

docs/firebase/COLLECTIONS.md

10.

docs/firebase/INDEXES.md

11.

docs/firebase/QUERY_PATTERNS.md
...
Architecture Documentation (docs/01_ARCHITECTURE)

14.

Database Documentation (docs/02_DATABASE)

15.

Backend Documentation (docs/03_BACKEND)

16.

Security Documentation (docs/04_SECURITY)

17.

API Documentation (docs/05_API)

18.

UI Documentation (docs/06_UI)

19.

AI Documentation (docs/07_AI, docs/firebase/AI_ARCHITECTURE.md)

20.

DevOps Documentation (docs/08_DEVOPS)

21.

Testing Documentation (docs/09_TESTING)

22.

Deployment Documentation (docs/10_DEPLOYMENT)
...
## Original Platform (NestJS + Prisma + PostgreSQL)

All 15 phases of the original platform are COMPLETE & LOCKED:
...
## Firebase Migration (Current Focus)

The platform is undergoing a migration from PostgreSQL/Prisma to Firebase/Firestore.

Migration Phase 1 (Architecture & Documentation)

✅ COMPLETE & LOCKED

- Firebase Architecture Design (ARCHITECTURE_LOCK.md)
- Firestore data model (DOMAIN_MODEL.md)
- Repository contracts (REPOSITORY_CONTRACTS.md)
- Collection strategy (COLLECTIONS.md)
- Index design (INDEXES.md)
- Query patterns (QUERY_PATTERNS.md)
- Security rules (SECURITY_RULES.md)

Migration Phase 2 (Repository Implementation)

🔄 IN PROGRESS

- Repository Foundation: ✅ COMPLETE & LOCKED (BaseRepository, FirestoreService, TransactionManager, QueryBuilder, FirestoreMapper, shared types, error classes, contracts)
- Users Module: ✅ COMPLETE & LOCKED (domain + Firestore repository + service + API + 5 test suites)
- Curriculum Module: 🔄 IN PROGRESS (domain entities + repository + mapper + validator schemas done; service, API, tests, exports, documentation pending)

Migration Phase 3 (AI Integration & Optimization)
...
## Original Platform (Built & Deployed)
...
Firebase Authentication (session cookies, custom claims)
